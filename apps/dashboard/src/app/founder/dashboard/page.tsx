      ...
      cards: app
        ? [
            ...
            },
            {
              ...
              icon: <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center"><MessageSquare className="w-5 h-5 text-orange-600" /></div>,
        ...
        : [
            ...
            },
            {
              ...
              icon: <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center"><Building2 className="w-5 h-5 text-orange-600" /></div>,
              onClick: () => router.push('/founder/company'),
            },
            {
              id: '3',
