...
export function MemoViewer({ memo, onExportPDF }: MemoViewerProps) {
  const recommendationColors: Record<string, string> = {
    strong_accept: 'bg-green-100 text-green-600 border-green-300',
    accept: 'bg-blue-100 text-blue-600 border-blue-300',
    conditional: 'bg-yellow-100 text-yellow-600 border-yellow-300',
    lean_decline: 'bg-yellow-100 text-yellow-600 border-yellow-300',
    decline: 'bg-red-100 text-red-600 border-red-300',
  }
