        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <Link href={`/startup/${match.startup.id}`} className="font-medium hover:underline">
                {match.startup.name}
              </Link>
            ...
            <div>
              <p className="text-sm font-medium mb-1">What's blocking you?</p>
              <p className="text-sm text-muted-foreground">{match.bottleneck.rawBlocker}</p>
            </div>

            <div>
              <p className="text-sm font-medium mb-1">What have you tried?</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Link href={`/mentors/${match.mentor.id}`} className="font-medium hover:underline">
                  {match.mentor.name}
                </Link>
