      ...
      cards: [
        {
          ...
          icon: <div className="w-10 h-10 bg-destructive/15 rounded-lg flex items-center justify-center"><FileText className="w-5 h-5 text-destructive" /></div>,
        ...
        },
        {
          ...
          icon: <div className="w-10 h-10 bg-success/15 rounded-lg flex items-center justify-center"><BarChart className="w-5 h-5 text-success" /></div>,
          onClick: () => router.push('/founder/documents'),
        },
        {
          id: '3',
          ...
          icon: <div className="w-10 h-10 bg-info/15 rounded-lg flex items-center justify-center"><Building2 className="w-5 h-5 text-info" /></div>,
      ...
      cards: app
        ? [
            ...
            },
            {
              ...
              icon: <div className="w-10 h-10 bg-warning/15 rounded-lg flex items-center justify-center"><MessageSquare className="w-5 h-5 text-warning" /></div>,
        ...
        : [
            ...
            },
            {
              ...
              icon: <div className="w-10 h-10 bg-warning/15 rounded-lg flex items-center justify-center"><Building2 className="w-5 h-5 text-warning" /></div>,
              onClick: () => router.push('/founder/company'),
            },
            {
              id: '3',
